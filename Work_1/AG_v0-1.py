...
plt.xlabel('Subject number n') #naming the x axis
...
plt.colorbar(cp)
gen0 = plt.scatter(xData1, yData1, c='red')
genHalf = plt.scatter(xData2, yData2, c='purple')
genLast = plt.scatter(xData3, yData3, c='black')
