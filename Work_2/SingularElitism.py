...
while executionNumberN < 10:
    ...
    while generationN < numberOfGenerations:
        ...
        if generationN == 0:
            bestIndividualsInBeforeGeneration = currentPopulation[99]
        else: #implementa Elitismo Singular (o pior de P(t) é substituido pelo melhor de P(t-1))
            currentPopulation[0] = bestIndividualsInBeforeGeneration
